...
class PredictPipeline:
    def __init__(self):
        ...
        self.target_scaler_path = os.path.join("artifacts", "scaled.pkl") 
    ...
    def predict(self, input_data):
        try:
            ...
            logging.info("Applying StandardScaler transformation on input...")
            input_scaled = scaler_X.transform(input_data)

            logging.info("Applying PCA transformation on input...")
            ...
            if os.path.exists(self.target_scaler_path):
                ...
                logging.warning("Target scaler not found! Returning raw scaled predictions.")
...
if __name__ == "__main__":
    ...
    # Output Prediction
    print(f"Predicted Don Concentration: {prediction[0]:.2f}")